...
for subject in subjects:
    ...
    # Agarrar los 30 segundos previos y los 15 segundos posteriores
    for i in range(len(tiempos_block_start)):
        bloque = merged_df.iloc[tiempos_block_start.index[i]-(30*512):tiempos_block_end.index[i]+(15*512)]
