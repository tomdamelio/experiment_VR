...
non_immersive_instructions_text = {
    ...
    '5_post_stimulus_self_report_text_1': "Después de cada video, vas a tener que indicar tus niveles de \n"
        "valencia, activación emocional, preferencia, atención, familiaridad,\n"
        "y las emociones básicas que experimentaste durante el video, así como también tus niveles de mareo.\n\n"
        "Ahora vas a empezar a reportar verbalmente tus respuestas: utilizá una escala de 1 a 9 para cada dimensión, luego de que se te nombre cada emoción.\n\n"
        "Es importante que te concentres en tus emociones realmente sentidas durante el video.\n\n",
...
'6_post_stimulus_self_report_practice': 
    ...
    "Ahora, como última consigna, por favor indicá verbalmente con un número entero del 1 al 9 "
    "cuánta confianza tenés en este reporte verbal de tus emociones que acabás de hacer:\n"
    "   - 1 = sin confianza\n"
    "   - 9 = máxima confianza\n\n"
...
'7_post_stimulus_self_report': 
    ...
    "Ahora, como última consigna, por favor indicá con un número entero del 1 al 9 "
    "cuánta confianza tenés en este reporte verbal de tus emociones que acabás de hacer:\n"
    "   - 1 = sin confianza\n"
    "   - 9 = máxima confianza\n\n"
    "Realiza este reporte de confianza ahora.\n\n"
    ...
    '8_bis_confidence_luminance_practice_instructions_text': 
        "Ahora, quiero que indiques verbalmente cuánta confianza tenés en el reporte\n"
        "que realizaste con el joystick durante el video anterior.\n"
        "Usá un número entero del 1 al 9, donde:\n"
        "   - 1 = sin confianza\n"
        "   - 9 = máxima confianza\n\n"
    ...
    '8_bis_bis_confidence_verbal_report_practice_instructions_text': 
        "Ahora vas a reportar verbalmente cuánta confianza tenés en el reporte\n"
        "que realizaste recién.\n"
        "Usá un número entero del 1 al 9, donde:\n"
        "   - 1 = sin confianza\n"
        "   - 9 = máxima confianza\n\n"
        "Realiza este reporte de confianza ahora.\n\n"
    ...
    '11_bis_post_stimulus_verbal_report':
        "Quiero que indiques verbalmente cuánta confianza tenés en el reporte\n"
        "que realizaste verbalmente recien\n"
        "Usá un número entero del 1 al 9, donde:\n"
        "   - 1 = sin confianza\n"
        "   - 9 = máxima confianza\n\n"
        "Realiza este reporte de confianza ahora.\n\n"
