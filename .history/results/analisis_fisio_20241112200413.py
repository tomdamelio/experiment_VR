...
df_bio.to_csv(f'sub-{subject}/ses-A/fisio_bloque_1_sujeto_{subject}.csv')



#%%
df_bio = pd.read_csv(f'sub-{subject}/ses-A/fisio_bloque_1_sujeto_{subject}.csv').drop("Unnamed: 0",axis=1)
