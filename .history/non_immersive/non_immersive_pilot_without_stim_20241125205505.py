...
if ExperimentParameters.use_lsl:
    ...
    outlet = None  # Placeholder for cases where LSL is not used.
...
if ExperimentParameters.use_lsl:
    ...
    try:
        ...
        s = None  # No socket connection.
else:
    print("LSL is disabled for this session.")
    s = None  # No socket connection.
...
def mostrar_sliders_y_recoger_respuestas(win, outlet, sliders_dict, trials):
    ...
    if ExperimentParameters.use_lsl and outlet:
