...
def get_video_files_from_csvs(csv_directory):
    ...
    for csv_file in csv_files:
        ...
        for idx, row in df.iterrows():
            ...
            video_id_base = os.path.splitext(movie_path)[0]  # nombre base sin extensión
        ...
        if last_luminance_path != 'no':
            ...
            sequence_rows.append({
                ...
                "block_num": None,
                "description": description #"luminance_instructions"
            })
            ...
            sequence_rows.append({
                ...
                "block_num": None,
                "description": description #"luminance"
            })
