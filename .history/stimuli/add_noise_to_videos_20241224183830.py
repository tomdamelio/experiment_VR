...
def process_videos_in_folder(modality="2D"):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".mp4") or filename.endswith(".avi") or filename.endswith(".mov"):
            ...
            create_black_screen_video(7, "black_screen_7_sec.mp4", width=width_vid, height=height_vid)

            
            # Concatenar: black_screen_2_sec + flicker_1_sec_with_audio + video original + flicker_1_sec_final_with_audio + black_screen_7_sec
            ...
            black_7_clip = VideoFileClip("black_screen_7_sec.mp4")

            final_clip = concatenate_videoclips([black_2_clip, flicker_1_clip, original_clip, flicker_1_final_clip, black_7_clip])
